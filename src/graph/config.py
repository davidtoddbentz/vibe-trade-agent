...
_DEFAULT_SYSTEM_PROMPT = (
    ...
    "4. DO NOT MAKE ASSUMPTIONS on parameters. If required information is missing (symbol, timeframe, direction, thresholds, etc.), ask the user questions to gather it Do not make assumptions about the users intentions, only implement exactly what they request\n"
